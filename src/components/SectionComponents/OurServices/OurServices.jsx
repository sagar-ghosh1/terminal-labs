...
import shape2 from "@/assets/services/Light.png"

const OurServices = () => {
  return (
    <div className="bg-gradient-to-b from-[#110a15] from-10% via-[#120b16] via-30% to-[#140a1a] to-90% overflow-hidden relative" id="services">
      <div>
