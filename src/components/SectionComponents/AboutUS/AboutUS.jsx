...
const AboutUs = () => {
  return (
    <div className="bg-[#110A15] relative">
      <img className='absolute mt-10 ml-10' src={aboutLight} alt="" />
      <Container>
        <div className='flex justify-center'>
          <div className='w-1/2'>
            <img className='w-[900px] mix-blend-screen' src={aboutUsImg} alt="" />
          </div>
          ...
          <div className='w-1/2'>
            ...
            <div className='max-w-[520px]'>
              <h2 className='font-switzer text-[45px] font-semibold text-[#fff] w-full mb-[50px]'>Unveiling the Genesis of <span className='text-transparent bg-clip-text bg-gradient-to-r from-[#A84EFF] to-[#7815F8]'>Terminal Labs'</span> Name</h2>
              {/* three down card */}
              <div>
